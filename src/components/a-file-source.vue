    ...
    <div class="source">
        ...
        <div class="source-body" v-if="!localSource.collapsed">
            ...
            >
                ...
                >
                    Move original input files to this Folder after processing
                </a-folder-input>
            </validation-provider>

            <!-- Working folder -->
            <a-checkbox v-model="localSource.useWorkingDirectory">
                Use Working Folder?
            </a-checkbox>
            <validation-provider 
                slim
                :rules="{ required: localSource.useWorkingDirectory, 
                    pathunc: { allowed: false }, 
                    pathrelative: { allowed: false },
                    pathexists: true }" 
                v-slot="{ errors }"
                v-if="localSource.useWorkingDirectory"
            >
                <a-folder-input
                    title="Files generated by pipeline(s) will be written here first."
                    :errors="errors"
                    v-model="localSource.workingDirectory"
                >
                    Output files to this Folder first, and then move to Output Folder after processing
                </a-folder-input>
            </validation-provider>
    ...
    watch: {
        localSource: {
            ...
            handler: function(v) 
            {
                ...
                v.workingDirectory = v.useWorkingDirectory ? v.workingDirectory : "";
